            ...
            function x(a) {
              switch (a.type) {
                ...
                case "INVALID_FBQ_METHOD":
                  var b = a.method;
                  return (
                    "\"fbq('" + b + "', ...);\" is not a valid fbq command."
                  );
          ...
          (function () {
            ...
            function c(a) {
              return function () {
                try {
                  for (
                    var c = arguments.length, d = Array(c), e = 0;
                    e < c;
                    e++
                  )
                    d[e] = arguments[e];
        ...
        return (function (g, h, i, j) {
          ...
          (function () {
            ...
            function l(a) {
              ...
              a =
                i(a) || h(a) || j(a) || i(a, { ignoreRequestLengthCheck: !0 });
        ...
        return (function (g, h, i, k) {
          ...
          (function () {
            ...
            var R = { PageView: new B(), PixelInitialized: new B() },
              ...
              T = new x(S, I);
            function ga(a) {
              for (var b in a) K.call(a, b) && (this[b] = a[b]);
              return this;
            }
            function U() {
              try {
            ...
            function W(a, b, c) {
              ...
              if (K.call(P, d)) {
                b != null && C(P[d].userData)
                  ? ((P[d].userData = e ? b || {} : {}),
                    T.loadPlugin("identity"))
            ...
            a.pixelId && ((M = !0), W(a.pixelId));
            ((M && N) || g.fbq !== g._fbq) &&
              H({ type: "CONFLICTING_VERSIONS" });
            O.length > 1 && H({ type: "MULTIPLE_PIXELS" });
            function ma() {
              ...
              var b = v(function () {
                ...
                L = i.href;
                if (L === Q) return;
                var a = new ga({ allowDuplicatePageViews: !0 });
            ...
            function na(b) {
              (a._initHandlers.push(b), X());
            }
            function oa() {
              return { pixelInitializationTime: J, pixels: O };
            }
            function pa(a) {
              ((a.instance = S),
                (a.callMethod = U),
...
/*
     FILE ARCHIVED ON 23:49:20 Jan 08, 2020 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 23:06:31 Jun 01, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 7.046
  captures_list: 0.948
  exclusion.robots: 0.063
  exclusion.robots.policy: 0.049
  esindex: 0.01
  cdx.remote: 17.202
  LoadShardBlock: 354.32 (6)
  PetaboxLoader3.datanode: 306.978 (8)
  load_resource: 567.942 (2)
  PetaboxLoader3.resolve: 409.355 (2)
*/
